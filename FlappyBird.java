...
public class FlappyBird {
 ...
 public static void drawBackground() {
  ...
  // Cloud 1
  drawClouds(width/6 + 35, 150);
  // Cloud 2
  drawClouds(width/2 + 150, 200);
 }
 ...
 public static void drawClouds(int centerWidth, int centerHeight) {
  Window.out.color("white");
  Window.out.circle(centerWidth, centerHeight, 75);
  
  Window.out.color("white");
  Window.out.circle(centerWidth + 75, centerHeight + 25, 50);
 ...
 public static void endGame(int finalScore) {
  ...
  Window.out.print("Your Final Score was: " + finalScore, 150, height / 3 * 2);
  Window.frame();
 }
}
